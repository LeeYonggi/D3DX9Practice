...
HRESULT MeshLoader::LoadGeometryFromOBJ(wstring strFilename)
{
...
HRESULT MeshLoader::LoadMaterialsFromMTL(wstring strFileName)
{
	...
	for (; ; )
	{
		...
		else if (0 == wcscmp(strCommand, L"map_Kd"))
		{
			...
			pMaterial->strTexture = wTemp.c_str() + pMaterial->strTexture;
...
void MeshLoader::InitMaterial(Material * pMaterial)
{
